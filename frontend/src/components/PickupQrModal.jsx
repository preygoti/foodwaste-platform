  ...
  return (
    ...
    >
      <div 
        ...
        className="relative glass-modal rounded-2xl w-full max-w-[calc(100vw-1rem)] sm:max-w-lg shadow-2xl overflow-hidden my-auto max-h-[90dvh] flex flex-col animate-in fade-in zoom-in-95 duration-150 print:max-w-none print:shadow-none print:border-0 print:w-full cursor-default"
      >
        {/* Compact Header */}
