  ...
  return (
    <div className="min-h-screen bg-wheat-50 text-forest-800 flex flex-col overflow-x-clip selection:bg-forest-800 selection:text-wheat-50 font-sans antialiased">
      ...
      <section id="hero" className="relative max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-16 sm:pb-24 grid md:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="md:col-span-5 relative animate-in fade-in zoom-in-95 duration-700 py-3.5 sm:py-0">
          {/* Subtle Floating Badge 1 (Top Left) */}
          <div className="absolute -top-3 left-1 sm:-left-3 z-20 flex items-center gap-1 sm:gap-1.5 px-2.5 py-1 sm:px-3 sm:py-1.5 bg-forest-800 text-wheat-50 rounded-full shadow-lg text-[10px] sm:text-xs font-mono font-semibold animate-float-slow border border-forest-600">
            <Leaf className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400" />
            <span>Food Saved 🌱</span>
          </div>

          {/* Subtle Floating Badge 2 (Bottom Right) */}
          <div className="absolute -bottom-3 right-1 sm:-right-2 z-20 flex items-center gap-1 sm:gap-1.5 px-2.5 py-1 sm:px-3 sm:py-1.5 bg-emerald-600 text-white rounded-full shadow-lg text-[10px] sm:text-xs font-mono font-semibold animate-float-delayed border border-emerald-500">
            <CheckCircle2 className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" />
            <span>Pickup Scheduled ✓</span>
          </div>

          {/* Subtle Floating Badge 3 (Top Right) */}
          <div className="absolute -top-3 right-1 sm:-right-2 z-20 flex items-center gap-1 sm:gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 bg-rose-50 text-rose-800 rounded-full shadow-md text-[10px] sm:text-[11px] font-mono font-semibold border border-rose-200">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-mono text-forest-800/70 border-b border-wheat-200/60 pb-6 text-center md:text-left w-full">
            ...
            <div className="flex items-center justify-center md:justify-end gap-3 shrink-0">
              <a
                ...
                className="inline-flex items-center gap-1.5 text-forest-800 hover:text-[#0a66c2] font-semibold transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="author noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-forest-800 hover:text-forest-950 font-semibold transition-colors"
