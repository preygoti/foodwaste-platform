    ...
    <div className="min-h-screen bg-wheat-50 text-forest-800 flex flex-col overflow-x-hidden selection:bg-forest-800 selection:text-wheat-50 font-sans antialiased">
      ...
      <footer className="py-12 px-5 sm:px-6 lg:px-8 bg-wheat-50 border-t border-wheat-200 w-full">
        <div className="max-w-6xl w-full mx-auto space-y-8">
          ...
          {/* 🌟 Verified Founder & Lead Engineer Profile (For Google Knowledge Graph & Visibility) */}
          <div className="bg-white/90 border border-wheat-200/90 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xs">
            <div className="flex items-center gap-3.5 text-center sm:text-left">
              <div className="w-10 h-10 rounded-xl bg-forest-900 text-gold-400 font-bold font-display flex items-center justify-center text-sm shadow-2xs shrink-0 border border-forest-800">
                PG
              </div>
              <div>
                <div className="flex items-center justify-center sm:justify-start gap-2 flex-wrap">
                  <span className="font-display font-bold text-forest-900 text-sm sm:text-base">
                    Prey Goti
                  </span>
                ...
                <p className="text-xs text-forest-800/70 mt-0.5 font-mono">
                  Architected & engineered Harvest Ledger for AI-driven zero-waste food redistribution.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#0a66c2] text-white hover:bg-[#084e96] rounded-xl font-medium text-xs transition-colors shadow-2xs"
              ...
              <a
                ...
                target="_blank"
                rel="author noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-forest-900 text-wheat-50 hover:bg-forest-800 rounded-xl font-medium text-xs transition-colors shadow-2xs border border-forest-700"
