...
import { KeyRound, Mail, Lock, AlertCircle, CheckCircle2, ArrowLeft, Loader2, RefreshCw, Eye, EyeOff } from "lucide-react";
import { api } from "../api";
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] w-full auth-page-mesh flex flex-col justify-start sm:justify-center items-center px-4 sm:px-6 py-8 sm:py-12 text-[#0F291E] pt-safe pb-safe relative overflow-x-clip">
      ...
      <div className="w-full max-w-md my-auto space-y-6 relative z-10">
        ...
        <div className="glass-modal rounded-2xl p-5 sm:p-8 space-y-6 shadow-xl border border-white/80">
          {/* Progress Indicator */}
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-wheat-200 rounded-xl pl-10 pr-11 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-forest-400 bg-white"
                  />
                  <button
                    type="button"
                  ...
                  >
                    {showNewPassword ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4 text-forest-700" />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {showConfirmPassword ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4 text-forest-700" />}
                  </button>
                </div>
              </div>
